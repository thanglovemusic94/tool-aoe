...
class ReviewResourceIT {
    ...
    private static final XacNhan DEFAULT_STATUS = XacNhan.Da_Xac_Nhan;
    private static final XacNhan UPDATED_STATUS = XacNhan.Chua_Xac_Nhan;
    ...
    public static Review createEntity(EntityManager em) {
        Review review = new Review().point(DEFAULT_POINT).userReviewId(DEFAULT_USER_REVIEW_ID).type(DEFAULT_TYPE).status(DEFAULT_STATUS);
        return review;
    }
    ...
    public static Review createUpdatedEntity(EntityManager em) {
        Review review = new Review().point(UPDATED_POINT).userReviewId(UPDATED_USER_REVIEW_ID).type(UPDATED_TYPE).status(UPDATED_STATUS);
        return review;
    }
    ...
    void putExistingReview() throws Exception {
        ...
        updatedReview.point(UPDATED_POINT).userReviewId(UPDATED_USER_REVIEW_ID).type(UPDATED_TYPE).status(UPDATED_STATUS);
    ...
    void partialUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.type(UPDATED_TYPE).status(UPDATED_STATUS);
    ...
    void fullUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.point(UPDATED_POINT).userReviewId(UPDATED_USER_REVIEW_ID).type(UPDATED_TYPE).status(UPDATED_STATUS);
