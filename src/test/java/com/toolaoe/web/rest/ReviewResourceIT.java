...
class ReviewResourceIT {
    ...
    private static final Integer DEFAULT_USER_REVIEW_ID = 1;
    private static final Integer UPDATED_USER_REVIEW_ID = 2;

    private static final Type DEFAULT_TYPE = Type.THAO_TAC_TAY;
    private static final Type UPDATED_TYPE = Type.EP_DOI;
    ...
    public static Review createEntity(EntityManager em) {
        Review review = new Review()
            .point(DEFAULT_POINT)
            .userReviewId(DEFAULT_USER_REVIEW_ID)
            .type(DEFAULT_TYPE)
    ...
    public static Review createUpdatedEntity(EntityManager em) {
        Review review = new Review()
            .point(UPDATED_POINT)
            .userReviewId(UPDATED_USER_REVIEW_ID)
            .type(UPDATED_TYPE)
    ...
    void createReview() throws Exception {
        ...
        assertThat(testReview.getUserReviewId()).isEqualTo(DEFAULT_USER_REVIEW_ID);
        assertThat(testReview.getType()).isEqualTo(DEFAULT_TYPE);
    ...
    void getAllReviews() throws Exception {
        ...
        restReviewMockMvc
            ...
            .andExpect(jsonPath("$.[*].userReviewId").value(hasItem(DEFAULT_USER_REVIEW_ID)))
    ...
    void getReview() throws Exception {
        ...
        restReviewMockMvc
            ...
            .andExpect(jsonPath("$.userReviewId").value(DEFAULT_USER_REVIEW_ID))
    ...
    void putExistingReview() throws Exception {
        ...
        assertThat(testReview.getUserReviewId()).isEqualTo(UPDATED_USER_REVIEW_ID);
        assertThat(testReview.getType()).isEqualTo(UPDATED_TYPE);
    ...
    void partialUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.type(UPDATED_TYPE).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
