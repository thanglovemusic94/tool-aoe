    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                if (applicationUser.getInGame() != null) {
                    existingApplicationUser.setInGame(applicationUser.getInGame());
                }
                ...
                if (applicationUser.getAge() != null) {
                    existingApplicationUser.setAge(applicationUser.getAge());
                }
                if (applicationUser.getStartDate() != null) {
                    existingApplicationUser.setStartDate(applicationUser.getStartDate());
                }
                if (applicationUser.getEndDate() != null) {
                    existingApplicationUser.setEndDate(applicationUser.getEndDate());
                }
