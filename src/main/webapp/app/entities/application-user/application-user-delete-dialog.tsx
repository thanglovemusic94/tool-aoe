...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="toolaoeApp.applicationUser.delete.question">
        <Translate contentKey="toolaoeApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
